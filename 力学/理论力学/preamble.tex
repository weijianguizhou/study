...
% --- 「睡莲」封面配色（cover_Impression风.tex 使用，莫奈《睡莲》系列取色） ---
\definecolor{wlSky}{RGB}{224,232,228}       % 天光浅青绿（画面基底，含倒影天光）
\definecolor{wlSkyHigh}{RGB}{244,246,242}   % 天光高亮（顶部泛白）
\definecolor{wlWater}{RGB}{84,124,120}      % 水面中调青绿（主体色）
\definecolor{wlWaterDeep}{RGB}{40,74,74}    % 水面深青（莲影暗部）
\definecolor{wlWaterLight}{RGB}{150,182,176}% 水面亮斑（天光/月影倒影）
\definecolor{wlLeaf}{RGB}{46,92,58}         % 睡莲叶深绿（主叶色）
\definecolor{wlLeafLight}{RGB}{84,132,84}   % 睡莲叶亮绿（受光叶面）
\definecolor{wlFlower}{RGB}{244,224,224}    % 睡莲花粉白（花瓣）
\definecolor{wlFlowerLight}{RGB}{252,242,236} % 睡莲花亮白（受光花瓣）
\definecolor{wlFlowerCore}{RGB}{228,196,150}  % 睡莲花蕊金黄

% --- 段内小标题：独立成行黑体小标题（不进目录） ---
\newcommand{\parahead}[1]{\par\vspace{0.9em}\noindent{\heiti\color{structurecolor!90}#1}\par\vspace{0.15em}}
