...
\begin{tikzpicture}[scale=1.0]
    ...
    \begin{scope}[xshift=9.0cm]
        ...
        \draw[green!50!black,thick] plot[domain=-1.5:1.5,samples=50] (\x,{-0.7*\x/(1+abs(\x))});
        \draw[green!50!black,thick] plot[domain=0.2:1.8,samples=50] (\x,{sqrt(\x*\x-0.04)});
        \draw[green!50!black,thick] plot[domain=0.2:1.8,samples=50] (\x,{-sqrt(\x*\x-0.04)});
        \draw[green!50!black,thick] plot[domain=0.2:1.8,samples=50] ({-\x},{sqrt(\x*\x-0.04)});
        \draw[green!50!black,thick] plot[domain=0.2:1.8,samples=50] ({-\x},{-sqrt(\x*\x-0.04)});
        \node at (0,-2.2) {\titleC};
...
\begin{tikzpicture}[scale=1.1]
    ...
    \foreach \E in {0.3,0.6,0.9,1.2,1.5,1.8,2.1} {
        \pgfmathsetmacro\halfDomain{acos(max(-1,-\E))/57.2958}
        \draw[blue,thick,smooth,variable=\t,domain=-\halfDomain:\halfDomain,samples=100]
