...
\usepackage{amssymb,amsmath,amsthm,bm}                             % 数学字体
\usepackage{esint}                                                 % \oiint, \oiiint 等带圈积分符号
...
\usepackage{longtable}  % 可跨页断行的长表格（随文排版，不留浮动空白）
\setlength{\LTleft}{\fill}\setlength{\LTright}{\fill}  % longtable 水平居中
...
\newcommand{\blocksep}{\vspace{1em}}
% 段落级小标题：替代默认 \paragraph 的行内样式（独立成行的黑体小标题）
\newcommand{\parahead}[1]{\par\vspace{0.9em}\noindent{\heiti #1}\par\vspace{0.3em}}
% ------------------------------------------------------------%
...
% --- 「星月夜」封面配色（cover_Impression风.tex 使用，梵高《星月夜》取色 + VividBook 设计语言） ---
\definecolor{vnNight}{RGB}{18,18,72}         % 深夜靛蓝（天空主色）
\definecolor{vnNightMid}{RGB}{30,35,100}     % 夜空中层蓝
\definecolor{vnNightLight}{RGB}{55,65,135}   % 夜空浅蓝（旋涡亮部）
\definecolor{vnMoon}{RGB}{245,215,70}        % 月亮明黄
\definecolor{vnMoonGlow}{RGB}{235,205,95}    % 月亮光晕
\definecolor{vnStar}{RGB}{255,242,115}       % 星星亮黄
\definecolor{vnStarGlow}{RGB}{225,205,85}    % 星光晕
\definecolor{vnVillage}{RGB}{25,25,50}       % 村庄深色剪影
\definecolor{vnHill}{RGB}{35,45,75}          % 山丘暗蓝
\definecolor{vnTree}{RGB}{18,28,45}          % 柏树深色
\definecolor{vnCypress}{RGB}{30,50,35}       % 柏树暗绿
\definecolor{vnAccent}{RGB}{180,120,220}     % VividBook 风格紫色点缀
\definecolor{vnAccentPink}{RGB}{220,100,160} % VividBook 风格粉色点缀
\definecolor{vnAccentTeal}{RGB}{80,200,200}  % VividBook 风格青色点缀
