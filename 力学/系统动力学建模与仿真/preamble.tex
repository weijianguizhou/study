...
% ============================================================
%  系统动力学本地定制（保留原 preamble 中的内容）
% ============================================================
\usepackage{bm}   % 粗体数学符号

% 小结内 结论／证明／例题 之间的分隔横线
\newcommand{\blocksep}{\par\vspace{0.8em}\noindent\rule{\linewidth}{0.4pt}\vspace{0.8em}\par}
\renewenvironment{proof}[1][推导]{\blocksep\noindent{\heiti\color{structurecolor}#1：}\;\songti}{\hfill\textcolor{gold}{\rule{0.55em}{0.55em}}\par\vspace{0.3em}}
\renewenvironment{solution}{\blocksep\noindent\underline{{\heiti 解.}} \;\kaishu}{\par\vspace{0.4em}}

% 不编号的段落级小标题（用于替代过细的 subsection/subsubsection）
\titleformat{\paragraph}[hang]{\bfseries}{}{0pt}{%
	\color{structurecolor}\normalsize\bfseries}
\titlespacing*{\paragraph}{0pt}{2ex plus .5ex}{0.8em}