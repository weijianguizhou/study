...
- [[../ODE常微分方程|常微分方程]] — Laplace 变换是解 ODE 的重要工具
- [[Fourier 变换.tex|Fourier 变换]] — 频域分析的近亲
- [[Z 变换.tex|Z 变换]] — 离散时间系统的 Laplace 变换类比
- [[../代数/赫尔维茨矩阵（Hurwitz Matrix|Hurwitz 矩阵]] — 传递函数的稳定性分析
- [[../../自动控制原理/控制理论教程/00-控制理论MOC|控制理论教程]] — Laplace 变换在控制中的核心地位
