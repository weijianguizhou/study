...
\begin{center}
\input{figures/fig_pendulum.tikz}
\end{center}
...
\begin{center}
\input{figures/fig_series_before.tikz}
$\Longrightarrow$
\input{figures/fig_series_after.tikz}
\end{center}
...
\begin{center}
\input{figures/fig_parallel_before.tikz}
$\Longrightarrow$
\input{figures/fig_parallel_after.tikz}
\end{center}
...
\begin{center}
\input{figures/fig_feedback_before.tikz}
$\Longrightarrow$
\input{figures/fig_feedback_after.tikz}
\end{center}
...
\begin{center}
\input{figures/fig_msd_blocks.tikz}
\end{center}

先化简由 $\frac{1}{m}$、第一个 $\frac{1}{s}$ 与 $c$ 构成的阻尼内环，再化简由前向通道与 $k$ 构成的弹性外环，简化过程为：

\begin{center}
\input{figures/fig_msd_step1.tikz}
$\Longrightarrow$
\input{figures/fig_msd_step2.tikz}
\end{center}
