% ============================================================
%  课程笔记模板 —— LaTeX book + 中文课堂笔记排版（源自材料力学笔记）
%  编译方式: XeLaTeX（中文推荐），需编译两次生成目录
%  用法:
%    1. 替换所有 【】 标记内容；
%    2. 每章一个 .tex 文件，在正文用 \input{} 引入；
%    3. 封面图片放入 Figure/cover.jpg（可选，无图则注释掉对应行）；
%    4. 定理/定义/例题等环境见示例章节 第一章示例.tex。
% ============================================================
...
\newcommand{\notebody}{
	\chapter{【第一章 章节名称】}
	\input{第一章示例}      % 每章一个 .tex 文件，按需增删 \input{}
	% \input{第二章}
	% \input{第三章}
}
