...
\begin{enumerate}
    ...
    \item 两构件在多处组成平面高副，且高副元素接触处公法线相重合，此时仅计算一处高副，其余引入虚约束。
\end{enumerate}
\begin{figure}[htbp]
	\centering
	% 第一行，用 \hfill 填充水平空白，实现左右分布
	\begin{subfigure}[b]{0.35\textwidth}
		\centering
		\includegraphics[width=\linewidth]{figure/虚约束情况1.png}
		\caption{情况1}
		\label{fig:sub1}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.35\textwidth}
		\centering
		\includegraphics[width=\linewidth]{figure/虚约束情况2.png}
		\caption{情况2}
		\label{fig:sub2}
	\end{subfigure}
	
	\par % 换行符，分隔上下两行
	\vspace{0.3cm} % 可选：增加垂直间距，让布局更美观
	
	% 第二行
	\begin{subfigure}[b]{0.35\textwidth}
		\centering
		\includegraphics[width=\linewidth]{figure/虚约束情况3.png}
		\caption{情况3}
		\label{fig:sub3}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.35\textwidth}
		\centering
		\includegraphics[width=\linewidth]{figure/虚约束情况4.png}
		\caption{情况4}
		\label{fig:sub4}
	\end{subfigure}
