...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[LE,RO]{\small\kaishu 深度学习：从数学基础到大模型}
		...
		\begin{tikzpicture}[remember picture,overlay]
			...
			\node[anchor=center,text=DarkBlue]at([yshift=-16cm]current page.north){
				\begin{minipage}{0.85\paperwidth}
					\centering
					{\fontsize{36}{44}\sffamily\bfseries 深度学习}\\[0.5cm]
					{\fontsize{20}{28}\sffamily 从数学基础到大模型}\\[1.5cm]
					{\fontsize{14}{18}\kaishu 基于 RethinkFun 教程的扩展笔记}\\[2cm]
