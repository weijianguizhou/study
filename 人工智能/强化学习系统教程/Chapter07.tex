...
\begin{tikzpicture}[node distance=2cm, auto,
    ...
    diamond/.style={diamond, draw=red!60, fill=red!10, thick, minimum width=2.5cm, minimum height=0.8cm, align=center, aspect=2},
    ...
    \node[diamond, below=of norm] (epoch) {for epoch = 1..K};
