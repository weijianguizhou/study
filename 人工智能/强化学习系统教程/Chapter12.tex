...
\begin{tikzpicture}[>=stealth, scale=0.95]
    ...
    % RL algorithm
    \node[draw,rectangle,rounded corners,fill=green!10,minimum width=3cm,minimum height=2.5cm,align=center] (rl) at (9,2.5) {RL 算法\\(PPO/SAC/TD3)};
    ...
    % Real robot
    \node[draw,circle,minimum size=1.5cm,fill=red!10,align=center] (robot) at (12,2.5) {真实\\机器人};
...
\begin{tikzpicture}[>=stealth, scale=0.9]
    % Sim domain
    \node[draw,rectangle,rounded corners,fill=blue!10,minimum width=3cm,minimum height=2cm,align=center] (sim) at (0,0) {仿真域\\$\states_{\text{sim}}$};
    
    % Real domain
    \node[draw,rectangle,rounded corners,fill=red!10,minimum width=3cm,minimum height=2cm,align=center] (real) at (10,0) {真实域\\$\states_{\text{real}}$};
...
\begin{tikzpicture}[>=stealth, scale=1.0]
    ...
    \node[draw,circle,fill=yellow!20,minimum size=3cm,align=center] (center) at (0,0) {Sim-to-Real\\迁移};
