...
- [[../../刚体动力学算法/刚体动力学算法|刚体动力学算法]] — 空间向量代数
- [[../../刚体动力学算法/空间向量代数/1.空间速度 (Spatial Velocity)|空间速度]]
- [[../../刚体动力学算法/空间向量代数/2.空间力 (Spatial Force )|空间力]]

### 仿真环境
- [[../../Mujoco/Overview|MuJoCo 概述]] — 主流物理仿真引擎
- [[../../Mujoco/Modeling 建模|MuJoCo 建模]]
- [[../../Mujoco/代码设计的方法论Methodology|MuJoCo 代码设计]]

### 数学工具
- [[../../数理基础/ODE常微分方程|常微分方程]] — 动力学是 ODE
- [[../../数理基础/微分方程与动力系统|动力系统]] — 稳定性分析
- [[../../数理基础/随机微分方程SDE|随机微分方程]] — 噪声环境下的控制
...
第5步: 在 MuJoCo 仿真中实践 → [[../../Mujoco/Overview|MuJoCo]]
...
- [[../../刚体动力学算法/刚体动力学算法|刚体动力学算法]] — 正逆动力学
- [[../../刚体动力学算法/空间向量代数/0.数学知识预备|空间向量代数]]
- [[../../Mujoco/Overview|MuJoCo]]
- [[../../Mujoco/代码设计的方法论Methodology|MuJoCo 代码设计]]
- [[../../数理基础/ODE常微分方程|常微分方程]] — 动力学是 ODE
- [[../../数理基础/微分方程与动力系统|动力系统]] — 稳定性
- [[../../数理基础/随机微分方程SDE|随机微分方程]] — 随机控制
- [[../../数理基础/凸优化|凸优化]] — 轨迹优化
